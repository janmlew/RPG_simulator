...
archetypes_dict = {1: [acolyte_drives, acolyte_catalysts, acolyte_growth, acolyte_friends, acolyte_assets, acolyte_items, acolyte_antagonists, acolyte_rivals, acolyte_locs, acolyte_monsters, acolyte_plot_hooks],
                   2: [acrobat_drives, acrobat_catalysts, acrobat_growth, acrobat_friends, acrobat_assets, acrobat_items, acrobat_antagonists, acrobat_rivals, acrobat_locs, acrobat_monsters, acrobat_plot_hooks],
                   3: [animal_whisperer_drives, animal_whisperer_catalysts, animal_whisperer_growth, animal_whisperer_friends, animal_whisperer_assets, animal_whisperer_items, animal_whisperer_antagonists, animal_whisperer_rivals, animal_whisperer_locs, animal_whisperer_monsters, animal_whisperer_plot_hooks],
                   4: [archivist_drives, archivist_catalysts, archivist_growth, archivist_friends, archivist_assets, archivist_items, archivist_antagonists, archivist_rivals, archivist_locs, archivist_monsters, archivist_plot_hooks],
                   5: [artisan_drives, artisan_catalysts, artisan_growth, artisan_friends, artisan_assets, artisan_items, artisan_antagonists, artisan_rivals, artisan_locs, artisan_monsters, artisan_plot_hooks],
                   6: [artist_drives, artist_catalysts, artist_growth, artist_friends, artist_assets, artist_items, artist_antagonists, artist_rivals, artist_locs, artist_monsters, artist_plot_hooks],
                   7: [barkeep_drives, barkeep_catalysts, barkeep_growth, barkeep_friends, barkeep_assets, barkeep_items, barkeep_antagonists, barkeep_rivals, barkeep_locs, barkeep_monsters, barkeep_plot_hooks],
                   8: [barrister_drives, barrister_catalysts, barrister_growth, barrister_friends, barrister_assets, barrister_items, barrister_antagonists, barrister_rivals, barrister_locs, barrister_monsters, barrister_plot_hooks],
                   9: [bounty_hunter_drives, bounty_hunter_catalysts, bounty_hunter_growth, bounty_hunter_friends, bounty_hunter_assets, bounty_hunter_items, bounty_hunter_antagonists, bounty_hunter_rivals, bounty_hunter_locs, bounty_hunter_monsters, bounty_hunter_plot_hooks],
                   10: [charlatan_drives, charlatan_catalysts, charlatan_growth, charlatan_friends, charlatan_assets, charlatan_items, charlatan_antagonists, charlatan_rivals, charlatan_locs, charlatan_monsters, charlatan_plot_hooks],
                   11: [cook_drives, cook_catalysts, cook_growth, cook_friends, cook_assets, cook_items, cook_antagonists, cook_rivals, cook_locs, cook_monsters, cook_plot_hooks],
                   12: [criminal_drives, criminal_catalysts, criminal_growth, criminal_friends, criminal_assets, criminal_items, criminal_antagonists, criminal_rivals, criminal_locs, criminal_monsters, criminal_plot_hooks],
                   13: [cultist_drives, cultist_catalysts, cultist_growth, cultist_friends, cultist_assets, cultist_items, cultist_antagonists, cultist_rivals, cultist_locs, cultist_monsters, cultist_plot_hooks],
                   14: [detective_drives, detective_catalysts, detective_growth, detective_friends, detective_assets, detective_items, detective_antagonists, detective_rivals, detective_locs, detective_monsters, detective_plot_hooks],
                   15: [emissary_drives, emissary_catalysts, emissary_growth, emissary_friends, emissary_assets, emissary_items, emissary_antagonists, emissary_rivals, emissary_locs, emissary_monsters, emissary_plot_hooks],
                   16: [entertainer_drives, entertainer_catalysts, entertainer_growth, entertainer_friends, entertainer_assets, entertainer_items, entertainer_antagonists, entertainer_rivals, entertainer_locs, entertainer_monsters, entertainer_plot_hooks],
                   17: [exile_drives, exile_catalysts, exile_growth, exile_friends, exile_assets, exile_items, exile_antagonists, exile_rivals, exile_locs, exile_monsters, exile_plot_hooks],
                   18: [explorer_drives, explorer_catalysts, explorer_growth, explorer_friends, explorer_assets, explorer_items, explorer_antagonists, explorer_rivals, explorer_locs, explorer_monsters, explorer_plot_hooks],
                   19: [farmer_drives, farmer_catalysts, farmer_growth, farmer_friends, farmer_assets, farmer_items, farmer_antagonists, farmer_rivals, farmer_locs, farmer_monsters, farmer_plot_hooks],
                   20: [folk_hero_drives, folk_hero_catalysts, folk_hero_growth, folk_hero_friends, folk_hero_assets, folk_hero_items, folk_hero_antagonists, folk_hero_rivals, folk_hero_locs, folk_hero_monsters, folk_hero_plot_hooks],
